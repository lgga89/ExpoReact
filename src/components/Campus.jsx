...
export function Campus() {
  return (
    <section id="Sede" class="campus">
      <div class="campus__general">
        <div class="campus__title">
        ...
        <div class="campus__container">
          ...
          <div class="campus__images">
            <img class="campus__img" src={Toxpan} alt="imagenLocal" />
          </div>
        </div>
      </div>
    </section>

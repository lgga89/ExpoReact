          ...
          <table>
            ...
            <tr>
              ...
              <td>
                ...
                <br />
                <li>Ing. Norma Rocío Nahle García - Secretaria de Energía.</li>
                <br />
                <li>
                  Dr. Evaristo Ovando Ramírez - Titular de la Secretaría de
                  Desarrollo Agropecuario, Rural y Pesca (SEDARPA) Gobierno del
                  Estado de Veracruz.
                </li>{" "}
                <br />
                <li>
        ...
        <article id="tab2">
          <table>
            ...
            <tr>
              ...
              <td>
                <strong>
                  Haifa Nutrinet: Sistema online para el manejo de la nutrición.
                </strong>
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                ...
                <li>
                  Mtra. Katia Isabel Herrera Quevedo - Secretaria de Desarrollo
                  Agropecuario del Edo de Morelos
                </li>
                <li>
                ...
                <li>
                  Moderador: José Luis Arizmendi Bahena - Encargado del Despacho
                  de la Representación de la "SADER" en el Estado de Morelos.
                </li>
              </td>
              <td>Salón de Usos Múltiples</td>
            </tr>
            <tr>
              ...
              <td>
                ...
                <li>
                  Moderador: Ing. Oscar Javier Fernández Morales - Encargado del
            ...
            <tr>
              ...
              <td>
                <strong>
                  Requisitos para la certificación de una biofábrica de insumos
                  orgánicos.
                </strong>
                <li>
